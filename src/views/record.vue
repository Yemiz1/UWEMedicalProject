  ...
  <div class="page__container">
    <div class="prices">
      ...
      <div class="prices_description">
        orders of order's customers have placed
      </div>
          ...
          <div class="modal-wrapper">
            <div class="modal-container">
              <div class="modal-header">
                <div class="modal__title h6">Create orders</div>
                <button
                  type="button"
                  class="modal-close"
                ...
                <div class="modal__fieldset">
                  ...
                  <div class="modal__row">
                    <div class="modal__field">
                      ...
                      <div class="modal__wrap">
                        <input class="modal__input" type="number" />
                      </div>
                    </div>
                    <div class="modal__field">
              ...
              <div class="modal-footer">
                <button
                  class="modal__btn button button--red-transparent"
                  @click="showModal = false"
                  type="submit"
                >
                  discard
            ...
            <div class="modal-container delete-modal">
              ...
              <div class="modal-body">
                <div class="modal__fieldset">
                  ...
                  <h6>delete order (# {{ deleteItem }})?</h6>
                  <p>
                    are you sure you want to delete this order, this is an
                    irreversible action?
                  </p>
                </div>
              </div>
              ...
              <div class="modal-footer">
                <button
                  class="modal__btn button button--blue-transparent"
                  @click="deleteModal = false"
                  type="submit"
                >
                  discard
                ...
                <button
                  class="modal__btn button button--red-white"
                  @click="deleteInfo(['yo'])"
                  type="submit"
                >
                  <svg
